import type { IColor, IHsl, IHsla, IHsv, IHsva, IParticle, IParticleHslAnimation, IRgb, IRgba } from "tsparticles/Core/Interfaces";
import type { HslAnimation } from "tsparticles/Options/Classes/HslAnimation";
