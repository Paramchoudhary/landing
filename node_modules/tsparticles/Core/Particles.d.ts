...
import { QuadTree } from "tsparticles/Utils";
...
import type { ICoordinates, IDelta, IMouseData, IParticle, IRgb } from "tsparticles/Core/Interfaces";
export declare class Particles {
    ...
    readonly updaters: import("tsparticles/Core/Interfaces").IParticleUpdater[];
